...
namespace ProviderITProvaPratica.Controllers
{
    public class DisciplinasController : Controller
    {
        ...
        public DisciplinasController(FaculdadeContexto context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("DisciplinaID,NomeDisciplina,Descricao,DataCriacao,CodigoDisciplina")] Disciplina disciplina)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DisciplinaID,NomeDisciplina,Descricao,DataCriacao,CodigoDisciplina")] Disciplina disciplina)
        {
